# lkgen
`lkgen` is a license generation and validation utility using the [gmsm-lk](https://github.com/phox/gmsm-lk) library as a backend.
...
```sh
go install github.com/phox/gmsm-lk/lkgen@latest
```
